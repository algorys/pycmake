...
class CMakeLists(object):
    ...
    def create_file(self, path):
        ...
        if self.cmakelists:
            try:
                self.cmakelists.write('# This file was automatically generated by PyCMake.\n')
                self.cmakelists.write('# WARNING: Do not edit this file unless you know what you are doing.\n')
            except PermissionError as e:
                print('Maybe you do not have sufficient rights : ' + e)
